...
pub fn select(nfds: libc::c_int, readfds: Option<&mut FdSet>, writefds: Option<&mut FdSet>, errorfds: Option<&mut FdSet>, timeout: Option<&libc::timeval>) -> io::Result<usize> {
    match unsafe {
        libc::select(
            nfds,
