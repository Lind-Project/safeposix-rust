...
impl Cage {
    ...
    pub fn open_syscall(&self, path: &str, flags: i32, mode: u32) -> i32 {
        ...
        // Retrieve the absolute path from the root directory
        let truepath = normpath(convpath(path), self);
    
        // Fetch the next file descriptor and its lock write guard
        ...
        // Walk through the absolute path which returns a tuple with inode number of file and parent
