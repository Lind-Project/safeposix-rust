...
pub struct ShmSegment {
    ...
    pub rmid: bool,
    pub attached_cages: interface::RustHashSet<u64>,
...
impl ShmSegment {
    pub fn new(key: i32, size: usize, cageid: u32, uid: u32, gid: u32, mode: u16) -> ShmSegment {
        ...
        ShmSegment { shminfo: shminfo, key:key, size: size, filebacking: filebacking, rmid: false, attached_cages: interface::RustHashSet::new(), semaphor_offsets: interface::RustHashSet::new()}
    }
    ...
    pub fn map_shm(&mut self, shmaddr: *mut u8, prot: i32, cageid: u64) -> i32{
        ...
        if self.shminfo.shm_nattch == 1 { self.attached_cages.insert(cageid); }
    ...
    pub fn unmap_shm(&mut self, shmaddr: *mut u8, cageid: u64) {
        ...
        if self.shminfo.shm_nattch == 0 { self.attached_cages.remove(&cageid); }
    }
}
...
impl ShmMetadata {
    pub fn init_shm_metadata() -> ShmMetadata {
        ShmMetadata { nextid: interface::RustAtomicI32::new(1), shmkeyidtable: interface::RustHashMap::new(), shmtable: interface::RustHashMap::new() }
    }
