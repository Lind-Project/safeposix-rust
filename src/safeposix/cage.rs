...
impl Cage {
    ...
    pub fn load_lower_handle_stubs(&mut self) {
        let stdin = interface::RustRfc::new(interface::RustLock::new(FileDescriptor::Stream(StreamDesc {position: 0, flags: O_RDONLY})));
        let stdout = interface::RustRfc::new(interface::RustLock::new(FileDescriptor::Stream(StreamDesc {position: 0, flags: O_WRONLY})));
        let stderr = interface::RustRfc::new(interface::RustLock::new(FileDescriptor::Stream(StreamDesc {position: 0, flags: O_WRONLY})));
